...
import com.foxfxb.interviewee.exception.SystemException;
...
public class JSONUtils {
    ...
    public static String toJson(Object object) {
        ...
        try {
            ...
            throw new SystemException("Erorr happen when parsing object to json");
        }
    }
    ...
    public static <T> T toObject(String json, Class<T> clazz) {
        ...
        try {
            ...
            throw new SystemException("Error happen when convent json to object, json: " + json + ", class: " + clazz,
                    e);
        }
    ...
    public static <T> T toObject(String json, JavaType javaType) {
        if (org.apache.commons.lang3.StringUtils.isEmpty(json)) {
            logger.debug("Convent json to object, json: {}, javaType: {}, return: {}", json, javaType, null);
            return null;
        }
        ...
        T returnObject = null;
        try {
            returnObject = mapper.readValue(json, javaType);
        } catch (IOException e) {
            throw new SystemException("Error happen when convent json to object, json: " + json + ", javaType: " + javaType,
                    e);
        }
        logger.debug("Convent json to object, json: {}, javaType: {}, return: {}", json, javaType, json);
        return returnObject;
    }
